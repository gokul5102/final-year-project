...
const RegisterLand = () => {
  ...
  let fillUpCoordinates = async () => {
    for (let i = 0; i < formValues.length; i++) {
      ...
      await setCoordinates([...coordinates, [formValues[i].lat, formValues[i].long]]);
    }
  };
  let handleSubmit = async (event) => {
    ...
    const data = { id: assetId, borderCoordinates: coordinates, owner: owner, appraisedValue: value };
